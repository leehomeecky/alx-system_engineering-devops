this is a breakdown of what each of the scripts in the directory dose
...
> A bash script that display current directory contents, including hidden files (starting with .). Use the long format.
...
> A bash script that moves all files beginning with an uppercase letter to the directory /tmp/u.
...
> A bash script that deletes all files in the current working directory that end with the character ~.
...
> A bash script that creates the directories welcome/, welcome/to/ and welcome/to/school in the current directory.
...
> A bash script that lists all the files and directories of the current directory, separated by commas (,).
